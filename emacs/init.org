...
**** Evil Leader
     #+BEGIN_SRC emacs-lisp
       ...
       (evil-leader/set-key "c=" 'indent-whole-buffer)
       (evil-leader/set-key "c<SPC>" 'er/expand-region)
...
***** Evil Keybinds
      #+BEGIN_SRC emacs-lisp
        ...
        (evil-global-set-key 'insert "x" 'zovt/maybe-esc)
...
** Custom Functions
   #+BEGIN_SRC emacs-lisp
     ...
     (defun zovt/maybe-esc ()
       "Maybe escape in insert mode after KEY-STRING is pressed."
       (interactive)
