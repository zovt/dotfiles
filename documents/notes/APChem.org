...
* Thu Oct 16 08:38:54 2014
** Quiz Review
*** Enthalpies of Reaction
dH = dHproducts - dHreactants
*** Calorimetry
The heat capacity of one mole of a substance is called its molar heat capacity
The heat capacity of one gram of a substance is called its specific heat capacity, or it's specific heat
Cm						= J/(m*C)
J/(m*C) * 1 mol Substance / 1 g Substance	= J / (g*C) = Cs
q						= m*Cs*dT
qsoln = (specific heat of Solution) * (grams of solution) * dT = -qrxn
Specific heat of water = 4.18 J/(g*C)
Find answer in kJ/m
**** Bomb Calorimetry
qrxn = -Ccal * dT
Reactions in a bomb calorimeter are carried out at a constant volume, so change in internal energy = dE rather than dH
*** Hess's Law
Balance equations and shit
dHrxn = sigma n dHf products - sigma m dHf reactants
* Mon Nov  3 10:50:54 2014
** Chapter 8
* Tue Nov  4 08:31:08 2014
** Test Review
*** Chapter 6
**** Wave nature of light
**** Highest wave length waves
**** Visible spectrum: 400 nm to 750 nm
**** E = hf
**** Line Spectrum and Reidberg equation in page 220
**** Know what the uncertainty principle is
     Can't know where an electron is and what its momentum is at the same time
**** What the quantum number stands for
***** q	= shell
***** l	= shape
***** ml = where
**** Three principles that govern the position of an electron
***** Aufbau's Rule
***** Hun's Rule
***** Paulie Exclusion Principle
**** How 2 fill orbital diagram
**** Need to know the exceptions
***** Chromium, Molybdenum, Copper, and Silver
**** Expanded and condensed electron configuration
*** Chapter 7
**** Effective nuclear charge
**** Ionization energy
**** Know the whole damn chapter
**** Electron Affinity
**** Metallic Character
* Mon Dec  8 11:51:21 EST 2014
1.5	= A = -log T
10^-1.5 = T = 0.032
%T	= 3.2 %
